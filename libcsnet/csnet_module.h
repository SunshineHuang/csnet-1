...
typedef void (*module_entry_cb) (csnet_ss_t* ss, csnet_head_t* head, char* data, int data_len);
...
void csnet_module_entry(csnet_module_t*, csnet_ss_t* ss, csnet_head_t* head, char* data, int data_len);
